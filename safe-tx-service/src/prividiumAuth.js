...
export let serviceAccountAddress = privateKeyToAccount(config.servicePrivateKey).address;
...
export async function getServiceToken() {
  ...
  const domain = config.domain || getDomainFromUrl(config.permissionsApiBaseUrl);
